...
<body>
    ...
    <div class="datasets-nav">
                <div class=" act_hov population_link"><a href="xmlPages/populationXml.php"><div class="hover_overlay"><h1>Population</h1></div></a></div>
                <div class="act_hov obesity_link"><a href="xmlPages/obesityXml.php"><div class="hover_overlay"><h1>Obesity</h1></div></a></div>
                <div class="act_hov happiness_link"><a href="xmlPages/happinessXml.php"><div class="hover_overlay"><h1>Happiness</h1></div></a></div>
            </div>
	</div>
